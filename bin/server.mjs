...
const argv = yargs(process.argv.slice(2))
  ...
  .options("domain", {
    describe:
      "Specify the base domain name. This is optional if hosting tunnelserver from a regular example.com domain. This is required if hosting a tunnelserver from a subdomain (i.e. tunnel.domain.tld where clients will be client-app.tunnel.domain.tld)",
  })
